...
import { FaUser, FaLock, FaEye, FaEyeSlash, FaUserPlus, FaEnvelope, FaArrowLeft } from "react-icons/fa";
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const response = await fetch("https://craft-server-opal.vercel.app/auth/register", {
        method: "POST",
